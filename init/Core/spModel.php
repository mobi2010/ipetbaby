...
class spModel {
	...
	public function findAll($conditions = null, $sort = null, $fields = null, $limit = null)
	{
		...
		$this->_sqls[] =  $sql = "SELECT {$fields} FROM {$this->tbl_name} {$where} {$sort}";
	...
	public function create($row)
	{
		...
		$this->_sqls[] = $sql = "INSERT INTO {$this->tbl_name} ({$col}) VALUES ({$val})";
	...
	public function delete($conditions)
	{
		...
		$this->_sqls[] = $sql = "DELETE FROM {$this->tbl_name} {$where}";
	...
	public function update($conditions, $row)
	{
		...
		$values = join(", ",$vals);
		$this->_sqls[] = $sql = "UPDATE {$this->tbl_name} SET {$values} {$where}";
		return $this->_db->exec($sql);
	}
